...
insert into game (id, image_url, title, platform_title, summary, first_release_date) values (999999, 'https://lh3.googleusercontent.com/YqlXGn_KbC5zxxEDr12vsYWjcMpZokEmGZ76opYh4VmRwa2FCP6fHYzFcad5-xj4C677=w300', 'Xbox Home', 'Xbox 360', 'Home screen for Xbox 360.', '2017-08-27');
insert into game (id, image_url, title, platform_title, summary, first_release_date) values (999998, 'https://lh3.googleusercontent.com/YqlXGn_KbC5zxxEDr12vsYWjcMpZokEmGZ76opYh4VmRwa2FCP6fHYzFcad5-xj4C677=w300', 'Xbox Home', 'Xbox One', 'Home screen for Xbox One.', '2017-08-27');
...
insert into game (image_url, title, platform_title, summary, first_release_date) values ('test.com', 'MLP', 'Xbox 360', 'MLP YAY', '2017-Aug-28');
