...
insert into game (id, image_url, title, platform_title) values (1, 'test.com', 'MLP', 'Xbox 360');
insert into game (id, image_url, title, platform_title) values (123, 'http://images.igdb.com/igdb/image/upload/t_cover_big/kln2xrk7av3dzrt60auq.png', 'Mass Effect: Andromeda', 'Xbox 360');
insert into game (id, image_url, title, platform_title) values (1234, 'http://images.igdb.com/igdb/image/upload/t_cover_big/m1qtsn4ehaen83bbp1ee.png', 'Forza Motorsport 3', 'Xbox 360');
insert into game (id, image_url, title, platform_title) values (125, 'http://images.igdb.com/igdb/image/upload/t_cover_big/gy5jzbxk068kduoki6wx.png', 'Fallout 4: Nuka World', 'PS3');
insert into game (id, image_url, title, platform_title) values (1236, 'http://images.igdb.com/igdb/image/upload/t_cover_big/fhbeilnghyhhmjqhinqa.png', 'Titanfall 2', 'PS3');
